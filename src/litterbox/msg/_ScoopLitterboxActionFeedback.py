"""autogenerated by genpy from litterbox/ScoopLitterboxActionFeedback.msg. Do not edit."""
import sys
...
class ScoopLitterboxActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "litterbox/ScoopLitterboxActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','litterbox/ScoopLitterboxFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ScoopLitterboxActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = litterbox.msg.ScoopLitterboxFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = litterbox.msg.ScoopLitterboxFeedback()
