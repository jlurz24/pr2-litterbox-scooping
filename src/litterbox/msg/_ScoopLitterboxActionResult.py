"""autogenerated by genpy from litterbox/ScoopLitterboxActionResult.msg. Do not edit."""
import sys
...
class ScoopLitterboxActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "litterbox/ScoopLitterboxActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','litterbox/ScoopLitterboxResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ScoopLitterboxActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = litterbox.msg.ScoopLitterboxResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = litterbox.msg.ScoopLitterboxResult()
