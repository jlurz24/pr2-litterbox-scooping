"""autogenerated by genpy from litterbox/DumpPoopActionResult.msg. Do not edit."""
import sys
...
class DumpPoopActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "litterbox/DumpPoopActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','litterbox/DumpPoopResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DumpPoopActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = litterbox.msg.DumpPoopResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = litterbox.msg.DumpPoopResult()
