"""autogenerated by genpy from litterbox/ExploreActionResult.msg. Do not edit."""
import sys
...
class ExploreActionResult(genpy.Message):
  ...
  _type = "litterbox/ExploreActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','litterbox/ExploreResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = litterbox.msg.ExploreResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = litterbox.msg.ExploreResult()
