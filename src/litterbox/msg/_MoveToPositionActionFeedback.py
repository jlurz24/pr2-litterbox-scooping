"""autogenerated by genpy from litterbox/MoveToPositionActionFeedback.msg. Do not edit."""
import sys
...
class MoveToPositionActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "litterbox/MoveToPositionActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','litterbox/MoveToPositionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MoveToPositionActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = litterbox.msg.MoveToPositionFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = litterbox.msg.MoveToPositionFeedback()
